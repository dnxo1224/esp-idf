...
static void wifi_csi_rx_cb(void *ctx, wifi_csi_info_t *info)
{
    ...
    ets_printf("CSI_DATA," MACSTR ",%d," MACSTR ",%d,%d,%d,%d,%d,%d,%d,%d,%d",
               MAC2STR(s_my_mac), rx_id, MAC2STR(info->mac), rx_ctrl->rssi, rx_ctrl->rate,
    ...
    ets_printf("CSI_DATA," MACSTR ",%d," MACSTR ",%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d",
               MAC2STR(s_my_mac), rx_id, MAC2STR(info->mac), rx_ctrl->rssi, rx_ctrl->rate, rx_ctrl->sig_mode,
